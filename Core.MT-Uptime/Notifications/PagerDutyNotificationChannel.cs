            ...
            : new
            {
                ...
                payload = new
                {
                    ...
                    custom_details = new
                    {
                        ...
                        status_code_meaning = StatusCodeGloss.For(evt.StatusCode),
                        resolved_address = evt.Enrichment?.ResolvedAddress,
                        // Renamed from last_status_code — see the note in WebhookNotificationChannel.
                        last_good_status_code = evt.Enrichment?.LastGoodStatusCode,
                        last_good_at = evt.Enrichment?.LastGoodAt?.ToString("o"),
